...
const Home = () => {
  ...
  return (
    <>
      {/* <Loader /> */}
      <NavBar/>
     {isLoggedIn && <main className="min-h-full bg-gradient-to-r from-blue-100 via-white to-green-100 flex flex-col items-center px-4 py-4 text-center hero">
        ...
        <div className="w-full flex justify-center">
          <p className="text-xl text-wrap sm:text-2xl text-gray-700 font-medium mb-8 text-center max-w-2xl quotes2">
